...
function btnsValues (first, second, third, totalSum) {
  
  if (radioBtns[0].checked || selectTicket.value === 'firstT')  {
    helperBtnCalculation(first, totalSum);
    return
  } 

  if (radioBtns[1].checked || selectTicket.value === 'secondT') {
    helperBtnCalculation(second, totalSum);
    return
  } 

  if (radioBtns[2].checked || selectTicket.value === 'thiordT') {
    helperBtnCalculation(third, totalSum);
    return
  }
}
...
butP.addEventListener('click', function() {
  ...
  btnsValues ( priceFirstTicketBasic, priceSecondTicketBasic, priceThirdTicketBasic, totalSumOfBasikModal)
})
...
butP2.addEventListener('click', function() {
  ...
  btnsValues ( priceFirstTicketSenior, priceSecondTicketSenior, priceThirdTicketSenior, totalSumOfSeniorModal)
})
